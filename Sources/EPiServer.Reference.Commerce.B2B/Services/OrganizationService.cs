...
using System.Linq;
using EPiServer.Reference.Commerce.B2B.Adapters;
...
namespace EPiServer.Reference.Commerce.B2B.Services
{
    ...
    public class OrganizationService : IOrganizationService
    {
        ...
        public string GetUserCurrentOrganizationLocation()
        {
            ...
            return B2BAdapters.MarketCodeAdapter(currentOrganization.Addresses.First().CountryCode);
        }

        public OrganizationModel GetOrganizationModel(Guid id)
        {
           return new OrganizationModel(_organizationDomainService.GetOrganizationEntityById(id.ToString()));
        }

        public List<OrganizationModel> GetOrganizationModels()
        {
            return _organizationDomainService.GetOrganizations()
