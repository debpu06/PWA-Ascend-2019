...
namespace EPiServer.Reference.Commerce.Site.Tests.Features.Cart.Controllers
{
    public class WishListControllerTests
    {
        ...
        public void Index_ShouldCreateViewModel()
        {
            ...
            _cartViewModelFactoryMock.Verify(s => s.CreateWishListViewModel(It.IsAny<ICart>(), It.IsAny<WishListPage>()));
        }
        ...
        public WishListControllerTests()
        {
            ...
            _cartViewModelFactoryMock.Setup(x => x.CreateWishListMiniCartViewModel(It.IsAny<ICart>())).Returns(new WishListMiniCartViewModel(new WishListPage()));
            _cartViewModelFactoryMock.Setup(x => x.CreateWishListViewModel(It.IsAny<ICart>(), It.IsAny<WishListPage>())).Returns(new WishListViewModel(new WishListPage()));
