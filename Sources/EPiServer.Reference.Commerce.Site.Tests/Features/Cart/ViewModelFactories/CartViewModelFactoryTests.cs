...
namespace EPiServer.Reference.Commerce.Site.Tests.Features.Cart.ViewModelFactories
{
    public class CartViewModelFactoryTests
    {
        ...
        {
            var viewModel = _subject.CreateWishListViewModel(_cart, new WishListPage());

            var expectedViewModel = new WishListViewModel(new WishListPage())
            {
                ItemCount = 1,
        ...
        {
            var viewModel = _subject.CreateWishListViewModel(null, new WishListPage());
        ...
        public void CreateWishListMiniCartViewModel_ShouldCreateViewModel()
        {
            ...
            var expectedViewModel = new WishListMiniCartViewModel(new WishListPage())
            {
                ItemCount = 1,
