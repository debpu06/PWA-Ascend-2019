...
namespace EPiServer.Reference.Commerce.Site.Tests.Features.Search.Controllers
{
    public class CategoryControllerTests
    {
        ...
        public void Index_WhenPassingFashionNode_ShouldPassItOnToFactory()
        {
            ...
            // Assert
            _viewModelFactoryMock.Verify(v => v.Create(fashionNode, It.IsAny<FilterOptionViewModel>(), It.IsAny<string>()));
        }
        ...
        public void Index_WhenPassingFormModel_ShouldPassItOnToFactory()
        {
            ...
            // Assert
            _viewModelFactoryMock.Verify(v => v.Create(It.IsAny<FashionNode>(), formModel, It.IsAny<string>()));
        }
        ...
        public CategoryControllerTests()
        {
            ...
            _httpRequestMock.Setup(x => x.QueryString).
