    ...
    public class ProductControllerTests : IDisposable
    {
        ...
        public void Index_ShouldReturnCorrectTypes()
        {
            _viewModelFactoryMock.Setup(x => x.Create(It.IsAny<FashionProduct>(), It.IsAny<string>()))
                .Returns(new FashionProductViewModel(new FashionProduct()) { Variant = new FashionVariant() });
        ...
        public void Index_WhenIsInEditModeAndHasNoVariation_ShouldReturnProductWithoutVariationView()
        {
            ...
            _viewModelFactoryMock.Setup(x => x.Create(It.IsAny<FashionProduct>(), It.IsAny<string>()))
                .Returns(new FashionProductViewModel(fashionProduct) {Variant = null, Product = fashionProduct});
        ...
        public void Index_WhenSkipTrackingIsTrue_ShouldNotSendTracking()
        {
            ...
            _viewModelFactoryMock.Setup(x => x.Create(It.IsAny<FashionProduct>(), It.IsAny<string>()))
                .Returns(new FashionProductViewModel(new FashionProduct()) { Variant = new FashionVariant(), Product = fashionProduct });
        ...
        private readonly Mock<IReviewActivityService> _reviewActivityService;
        ...
        public ProductControllerTests()
        {
            ...
            _reviewActivityService = new Mock<IReviewActivityService>();
        ...
        {
            var controller = new ProductController(() => _isInEditMode, _viewModelFactoryMock.Object, _reviewService.Object, _recommendationServiceMock.Object, _referenceConverterMock.Object, _reviewActivityService.Object);
