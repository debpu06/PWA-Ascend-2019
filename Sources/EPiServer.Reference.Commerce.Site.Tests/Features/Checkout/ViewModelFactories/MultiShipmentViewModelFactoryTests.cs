...
namespace EPiServer.Reference.Commerce.Site.Tests.Features.Checkout.ViewModelFactories
{
    public class MultiShipmentViewModelFactoryTests
    {
        ...
        {
            var viewModel = _subject.CreateMultiShipmentViewModel(_cart, new MultiShipmentPage(), true);
        ...
        {
            var viewModel = _subject.CreateMultiShipmentViewModel(_cart, new MultiShipmentPage(), false);
