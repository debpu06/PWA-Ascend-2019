    ...
    public class StoreService : IStoreService
    {
        ...
        public List<StoreItemViewModel> GetEntryStoresViewModels(string entryCode)
        {
            ...
            else if (entry.ClassTypeId.Equals("Product"))
            {
                ...
                {
                    codes.AddRange(_entryIdentityResolver.GetCodesByIds(product.GetVariants(_relationRepository).
                        Select(x => _referenceConverter.GetObjectId(x))).Values);
                }
            }
        ...
        {
            return TryGetStoreViewModel(_cookieService.Get(StoreCookie), out StoreItemViewModel storeViewModel) ?
                storeViewModel :
        ...
        {
            if (!TryGetStoreViewModel(storeCode, out StoreItemViewModel storeViewModel))
            {
                return false;
            }
