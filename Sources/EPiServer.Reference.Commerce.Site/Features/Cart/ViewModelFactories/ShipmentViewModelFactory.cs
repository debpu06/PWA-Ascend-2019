...
namespace EPiServer.Reference.Commerce.Site.Features.Cart.ViewModelFactories
{
    ...
    public class ShipmentViewModelFactory
    {
        ...
        public virtual ShippingMethodInfoModel InStorePickupInfoModel => _instorePickup ?? (_instorePickup = _shippingManagerFacade.GetInstorePickupModel());
        ...
        private IEnumerable<ShippingMethodViewModel> CreateShippingMethodViewModels(MarketId marketId, Currency currency, IShipment shipment)
        {
            ...
            if (shipment.LineItems.Count(o => o.GetEntryContentBase() is VirtualVariant) == shipment.LineItems.Count())
            {
        ...
        {
            var methods = _shippingManagerFacade.GetShippingMethodsByMarket(marketId.Value, false)
            ...
            return methods.Where(shippingMethodRow => currentLanguage.Equals(shippingMethodRow.LanguageId, StringComparison.OrdinalIgnoreCase)
                ...
                .Select(shippingMethodRow => _shippingManagerFacade.GetRate(shipment, shippingMethodRow, _marketService.GetMarket(marketId)));
        }
    }
}