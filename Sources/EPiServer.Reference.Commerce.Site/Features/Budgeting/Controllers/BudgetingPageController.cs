    ...
    public class BudgetingPageController : PageController<BudgetingPage>
    {
        ...
        public ActionResult Index(BudgetingPage currentPage)
        {
            ...
            var viewModel = new BudgetingPageViewModel
            {
                ...
                IsSubOrganization = !string.IsNullOrEmpty(_cookieService.Get(Constants.Fields.SelectedSuborganization))
            };
        ...
        public ActionResult AddBudget(BudgetingPage currentPage)
        {
            ...
            try
            {
                ...
                {
                    var suborganization = _organizationService.GetSubOrganizationById(_cookieService.Get(Constants.Fields.SelectedSuborganization));
        ...
        public ActionResult NewBudget(DateTime startDateTime, DateTime finishDateTime, decimal amount, string currency, string status)
        {
            ...
            try
            {
                ...
                if (!string.IsNullOrEmpty(_cookieService.Get(Constants.Fields.SelectedSuborganization)))
                {
                    organizationId = Guid.Parse(_cookieService.Get(Constants.Fields.SelectedSuborganization));
