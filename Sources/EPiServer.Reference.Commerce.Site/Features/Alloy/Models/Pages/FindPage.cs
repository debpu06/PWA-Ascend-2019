...
{
    [ContentType(DisplayName = "Find Search Page", GUID = "39c8b336-bcb1-4e31-9705-9eb0fda1263b", Description = "Search page based on EPiServer Find", AvailableInEditMode = false)]
    [AvailableContentTypes(IncludeOn = new[] { typeof(AlloyStartPage) })]
    [SiteImageUrl]
    public class FindPage : SitePageData, IHasRelatedContent, IUseDirectLayout
    {
        [Display(
