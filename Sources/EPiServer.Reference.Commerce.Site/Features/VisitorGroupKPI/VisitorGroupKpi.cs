...
namespace EPiServer.Reference.Commerce.Site.Features.VisitorGroupKPI
{
    [DataContract]
    public class VisitorGroupKpi : Kpi
    {
        ...
        private readonly IVisitorGroupRoleRepository visitorGroupRoleRepository;
        ...
        public VisitorGroupKpi()
        {
            ...
            visitorGroupRoleRepository = _servicelocator.GetInstance<IVisitorGroupRoleRepository>();
        ...
        public override IKpiResult Evaluate(object sender, EventArgs e)
        {
            ...
            if (HttpContext.Current.User != null)
            {
                ...
                if (visitorGroupRoleRepository.TryGetRole(SelectedVisitorGroup, out role))
                {
