...
namespace EPiServer.Reference.Commerce.Site.Features.Campaign.Services
{
    ...
    public class CampaignService : ICampaignService
    {
        ...
        public CampaignService(IRecipientListService campaignRecipientLists, IRecipientService campaignRecipient, CustomerContextFacade customerContext)
        {
        ...
        {
            var email = _customerContext.CurrentContact.CurrentContact?.Email;
        ...
        private void UpdateCurrentDate(string dateField, string email)
        {
            try
            {
                ...
                if (currentRecipientListId != -1)
                {
                    ...
                    {
                        { dateField, System.DateTime.Now.ToString("o") },
                        { "Email", email }
                    };
