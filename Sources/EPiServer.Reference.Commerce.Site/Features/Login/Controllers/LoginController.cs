...
namespace EPiServer.Reference.Commerce.Site.Features.Login.Controllers
{
    public class LoginController : IdentityControllerBase<LoginRegistrationPage>
    {
        ...
        /// <param name="returnUrl">The users previous URL location. When logging in the user will be redirected back to this URL.</param>
            ...
            string returnUrl)
        {
            ...
            try
            {
                ...
                return RedirectToLocal(url.AbsolutePath);
            }
            catch (Exception)
            {
            }
        ...
        public async Task<ActionResult> InternalLogin(LoginViewModel viewModel)
        {
            ...
            switch (result)
            {
                ...
                case SignInStatus.RequiresVerification:
                    return RedirectToAction("SendCode", "Login", new { viewModel.ReturnUrl, viewModel.RememberMe });
