...
{
    public class LoginPageViewModel : ContentViewModel<LoginRegistrationPage>
    {
        public LoginViewModel LoginViewModel { get; set; }
        public RegisterAccountViewModel RegisterAccountViewModel { get; set; }

        public LoginPageViewModel(LoginRegistrationPage currentPage, string returnUrl) : base(currentPage)
        {
