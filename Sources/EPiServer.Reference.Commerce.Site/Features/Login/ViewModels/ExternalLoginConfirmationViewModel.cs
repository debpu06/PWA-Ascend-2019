...
{
    public class ExternalLoginConfirmationViewModel : ContentViewModel<LoginRegistrationPage>
    {
        ...
        public ExternalLoginConfirmationViewModel(LoginRegistrationPage currentContent) : base(currentContent)
        {
