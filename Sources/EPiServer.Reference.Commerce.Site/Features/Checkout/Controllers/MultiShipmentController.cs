...
namespace EPiServer.Reference.Commerce.Site.Features.Checkout.Controllers
{
    public class MultiShipmentController : PageController<MultiShipmentPage>
    {
        ...
        {
            return View(_checkoutViewModelFactory.CreateMultiShipmentViewModel(CartWithValidationIssues.Cart, currentPage, User.Identity.IsAuthenticated));
        }
        ...
        private CartWithValidationIssues CartWithValidationIssues
        {
            get { return _cart ?? (_cart = _cartService.LoadCart(_cartService.DefaultCartName, true)); }
        }
