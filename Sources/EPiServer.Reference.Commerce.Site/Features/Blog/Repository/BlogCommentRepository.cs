...
namespace EPiServer.Reference.Commerce.Site.Features.Blog.Repository
{
    ...
    public class BlogCommentRepository : IBlogCommentRepository
    {
        ...
        public BlogCommentRepository(ICommentService commentService)
        {
        ...
        public BlogComment Add(BlogComment comment)
        {
            ...
            BlogCommentExtension commentEtx = new BlogCommentExtension(comment.Email);
        ...
        public IEnumerable<BlogComment> Get(PageCommentFilter filter, out long total)
        {
            ...
            try
            {
                ResultPage<Comment> pageComment = commentService.Get(
        ...
        private Comment AdaptBlogComment(BlogComment comment)
        {
            return new Comment(EPiServer.Social.Common.Reference.Create(comment.Target), EPiServer.Social.Common.Reference.Create(comment.Name), comment.Body, true);
        }
