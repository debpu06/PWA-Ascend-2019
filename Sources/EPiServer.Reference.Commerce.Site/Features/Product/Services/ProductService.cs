...
namespace EPiServer.Reference.Commerce.Site.Features.Product.Services
{
    ...
    public class ProductService : IProductService
    {
        ...
        public IEnumerable<VariationContent> GetVariants(BaseProduct currentContent)
        {
        ...
        public string GetSiblingVariantCodeBySize(string siblingCode, string size)
        {
            ...
            var siblingVariants = GetAvailableVariants(siblingsReferences).OfType<VariantBase>().ToList();
        ...
        private ProductTileViewModel CreateProductViewModelForVariant(ProductContent product, VariationContent variant)
        {
            ...
            var baseProduct = product as BaseProduct;
            viewModel.Brand = baseProduct != null ? baseProduct.Brand : string.Empty;
