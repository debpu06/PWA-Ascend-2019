...
namespace EPiServer.Reference.Commerce.Site.Features.Search.Services
{
    ...
    public class SearchService : ISearchService
    {
        ...
        public CustomSearchResult Search(IContent currentContent, FilterOptionViewModel filterOptions, string selectdFacets, int catalogId = 0)
        {
        ...
        public CustomSearchResult SearchWithFilters(IContent currentContent, FilterOptionViewModel filterOptions, IEnumerable<Filter> filters, int catalogId = 0)
        {
