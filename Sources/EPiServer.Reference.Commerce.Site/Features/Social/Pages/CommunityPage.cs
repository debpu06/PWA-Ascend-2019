...
namespace EPiServer.Reference.Commerce.Site.Features.Social.Pages
{

    /// <summary>
    /// Used for the pages that wish to contain Social community features
    /// </summary>
    [ContentType(DisplayName = "Community", GUID = "56ba715e-3fb9-4050-a5e3-ab7fe1690742", Description = "A reseller's community page using Episerver Social.", GroupName = SiteTabs.Social)]
    [ImageUrl("~/content/icons/blocks/cms-icon-block-25.png")]
    public class CommunityPage : SitePageData
    {
        /// <summary>
