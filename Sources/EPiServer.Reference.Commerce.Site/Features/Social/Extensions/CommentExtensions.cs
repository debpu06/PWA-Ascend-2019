...
namespace EPiServer.Reference.Commerce.Site.Features.Social.Extensions
{
    /// <summary>
    ...
    public static class CommentExtensions
    {
        ...
        {
            var targetReference = EPiServer.Social.Common.Reference.Create(
        ...
        public static Comment PublishComment(this IContent content, string authorId, string body, bool isVisible)
        {
            var authorReference = String.IsNullOrWhiteSpace(authorId) ?
                EPiServer.Social.Common.Reference.Empty :
                EPiServer.Social.Common.Reference.Create(String.Format(userReferenceFormat, authorId));
            var targetReference = EPiServer.Social.Common.Reference.Create(String.Format(resourceReferenceFormat, content.ContentGuid));
