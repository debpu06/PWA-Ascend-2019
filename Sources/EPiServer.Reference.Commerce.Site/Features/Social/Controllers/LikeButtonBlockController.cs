...
namespace EPiServer.Reference.Commerce.Site.Features.Social.Controllers
{
    ...
    public class LikeButtonBlockController : BlockController<LikeButtonBlock>
    {
        ...
        public override ActionResult Index(LikeButtonBlock currentBlock)
        {
            ...
            return PartialView("~/Features/Social/Views//LikeButtonBlock/Index.cshtml", blockModel);
        }
        ...
        {
            var targetPageRef = EPiServer.Social.Common.Reference.Create(PermanentLinkUtility.FindGuid(likeButtonBlock.PageLink).ToString());
            var raterUserRef = GetRaterRef();
