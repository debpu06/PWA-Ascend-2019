...
using System.Linq;
using EPiServer.Reference.Commerce.Site.Features.Social.Adapters.Groups;
using EPiServer.Reference.Commerce.Site.Features.Social.Adapters.Moderation;
...
namespace EPiServer.Reference.Commerce.Site.Features.Social.Repositories.Moderation
{
    /// <summary>
    ...
    public class CommunityMembershipModerationRepository : ICommunityMembershipModerationRepository
    {
        ...
        private Composite<WorkflowItem, AddMemberRequest> GetComposite(string user, string group)
        {
            ...
            filter.Filter.Target = EPiServer.Social.Common.Reference.Create(CreateUri(group, user));
        ...
        public void AddAModeratedMember(CommunityMember member)
        {
            ...
            var workflowItem = new WorkflowItem(
                ...
                EPiServer.Social.Common.Reference.Create(targetReference)              // ...identified with this reference
            );
        ...
        public void Moderate(string workflowId, string action, string userId, string communityId)
        {
            ...
            var requestReference = EPiServer.Social.Common.Reference.Create(CreateUri(membershipRequest.Group, membershipRequest.User));
