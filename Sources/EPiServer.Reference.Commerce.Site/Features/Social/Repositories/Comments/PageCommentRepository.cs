...
namespace EPiServer.Reference.Commerce.Site.Features.Social.Repositories.Comments
{
    /// <summary>
    ...
    public class PageCommentRepository : IPageCommentRepository
    {
        ...
        {
            return new Comment(EPiServer.Social.Common.Reference.Create(comment.Target), EPiServer.Social.Common.Reference.Create(comment.AuthorId), comment.Body, true);
        }
