...
namespace EPiServer.Reference.Commerce.Site.Features.Social.Repositories.Groups
{
    /// <summary>
    ...
    public class CommunityMemberRepository : ICommunityMemberRepository
    {
        ...
        public CommunityMember Add(CommunityMember communityMember)
        {
            ...
            try
            {
                var userReference = EPiServer.Social.Common.Reference.Create(communityMember.User);
        ...
        private CompositeCriteria<MemberFilter, MemberExtensionData> BuildCriteria(CommunityMemberFilter communityMemberFilter)
        {
            ...
            {
                compositeCriteria.Filter = new MemberFilter { User = EPiServer.Social.Common.Reference.Create(communityMemberFilter.UserId) };
            }
            else
            {
