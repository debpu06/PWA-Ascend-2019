...
namespace EPiServer.Reference.Commerce.Site.Features.Recommendations.Services
{
    public interface IRecommendationService
    {
        ...
        Task<TrackingResponseData> TrackSearch(HttpContextBase httpContext, string searchTerm, int pageSize, IEnumerable<string> productCodes);
        ...
        Task<TrackingResponseData> TrackAttribute(HttpContextBase httpContext, string attributeName, string attributeValue);
        ...
        IEnumerable<RecommendationResult> GetRecommendationContent(HttpContextBase httpContext, ContentRecommendationRequestModel recommendationRequest);        
    }
}